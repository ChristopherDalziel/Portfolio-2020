    ...
    <AboutContainer>
      <AboutContent>
        ...
        <p>
          ...
          down from my position to chase a new passion with the hope of finding
          a new career path. I believe the key to success is really giving it
          your all in every opportunity you have through every single task,
          every single day, through hard work anything can be achieved.
          <br />
          <br />
